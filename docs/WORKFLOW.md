...
Helpers/         - Utility classes (WindowHelper, future helpers)
...
MainWindow.xaml.cs - Window setup (title bar, frame navigation)
...
- **Theme Switching**: Instant (no processing, just UI refresh)
